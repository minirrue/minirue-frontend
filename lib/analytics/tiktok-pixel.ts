...
export function tiktokPixelBaseCode(id: string): string {
  return `if(${ADS_OFF_INLINE_CHECK}){!function (w, d, t) { w.TiktokAnalyticsObject=t; var ttq=w[t]=w[t]||[]; ttq.methods=["page","track","identify","instances","debug","on","off","once","ready","alias","group","enableCookie","disableCookie","holdConsent","revokeConsent","grantConsent"]; ttq.setAndDefer=function(t,e){t[e]=function(){t.push([e].concat(Array.prototype.slice.call(arguments,0)))}}; for(var i=0;i<ttq.methods.length;i++)ttq.setAndDefer(ttq,ttq.methods[i]); ttq.load=function(e){var mrGo=function(){if(w.__mrTtLoaded)return;w.__mrTtLoaded=1;var n=document.createElement("script");n.type="text/javascript";n.async=!0;n.src="https://analytics.tiktok.com/i18n/pixel/events.js?sdkid="+e+"&lib="+t;var r=document.getElementsByTagName("script")[0];r.parentNode.insertBefore(n,r)};var mrIdle=function(){w.requestIdleCallback?w.requestIdleCallback(mrGo,{timeout:3000}):setTimeout(mrGo,1200)};d.readyState==="complete"?mrIdle():w.addEventListener("load",mrIdle,{once:true});["pointerdown","keydown","touchstart"].forEach(function(ev){w.addEventListener(ev,mrGo,{once:true,passive:true})})}; ttq.load('${id}'); ttq.page(); }(window, document, 'ttq');}`;
}
